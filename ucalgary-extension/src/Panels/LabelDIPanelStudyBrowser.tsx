 ...
 * @param {*} param0
 */
function LabelDIPanelStudyBrowser({
  DisplaySetService,
  getImageSrc,
  ...
  useEffect(() => {
    ...
    async function fetchStudiesForPatient(StudyInstanceUID) {
      ...
      if (isMounted.current) {
        const patientIdentifiers = {patientID: actuallyMappedStudies[0].patientID, patientName: actuallyMappedStudies[0].patientName};
  ...
  return (
    <>
      <div className="flex flex-col justify-between bg-secondary-main">
        <div>
          <span className="text-base font-bold text-white pr-2">Patient name:</span>
          <span className="text-base text-primary-light">{patientIdentifiers.patientName}</span>
        </div>
        <div>
          <span className="text-base font-bold text-white pr-2">Patient ID:</span>
          <span className="text-base text-primary-light">{patientIdentifiers.patientID}</span>
        </div>
      </div>
      <StudyBrowser
        tabs={tabs}
...
LabelDIPanelStudyBrowser.propTypes = {
...
export default LabelDIPanelStudyBrowser;
